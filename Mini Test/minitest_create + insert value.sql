...
-- insert into tours(TourTypeID, TypeID, Price, DayStart, DayEnd)
-- values (2, 'DLB001', 12.50, '2024-04-12', '2024-04-15'),
-- (1, 'DLT001', 115.50, '2023-04-01', '2024-04-01'),
-- (1, 'DLT002', 76.45, '2023-12-10', '2024-03-10'),
-- (2, 'DLB002', 45.99, '2023-06-14', '2023-08-15'),
-- (1, 'DLT003', 59.10, '2024-01-01', '2024-04-01'),
-- (2, 'DLB003', 78.75, '2023-05-06', '2024-06-05'),
-- (1, 'DLT004', 118.65, '2023-09-10', '2023-09-15'),
-- (2, 'DLB004', 67.34, '2023-07-10', '2023-07-13'),
-- (1, 'DLT005', 99.12, '2024-06-01', '2024-06-10'),
-- (2, 'DLB005', 55.60, '2023-08-12', '2024-08-30'),
-- (1, 'DLT006', 105.89, '2023-06-21', '2024-07-21'),
-- (2, 'DLB006', 68.90, '2024-03-05', '2024-04-10'),
-- (1, 'DLT007', 130.68, '2023-05-31', '2024-04-11'),
-- (2, 'DLB007', 94.30, '2024-01-02', '2024-12-10'),
-- (1, 'DLT008', 129.79, '2024-02-12', '2024-06-07');
